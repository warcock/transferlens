          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 md:w-10 md:h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                <span className="material-symbols-outlined text-primary text-lg md:text-xl">looks_two</span>
              </div>
              <div>
                <div className="text-xs md:text-sm font-bold text-primary uppercase tracking-wider">Stage 2</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm font-medium text-text-secondary">Question 3 of 6</span>
            </div>
          </div>
